        ...
        <div class="row">
            <div class="col ">
                <div class="main-block">
                    <div class="coverPicture" style="background: url({{asset('img/users/cover_picture/' . \App\Models\User::find($followedUser_id)->cover_photo)}});"></div>
                    <div class="profilePicture" style="background: url({{asset('img/users/profile_picture/' . \App\Models\User::find($followedUser_id)->profile_photo)}});"></div>
                    <div class="FullName text-center  fs-18 ProjectColor ">
                        {{\App\Models\User::find($followedUser_id)->name}}
                    </div>
                    <a href="{{route('profile.chat',$followedUser_id)}}"><i class="fa fa-commenting-o" aria-hidden="true" style="position: absolute;right: 150px;top: 300px; font-size: 30px"></i></a>
                @if(\App\Models\User::isFollowHim($followedUser_id))
                        <a href="{{route('profile.unfollow',$followedUser_id)}}" style="margin-left: 850px;margin-bottom: 10px;color: white" class="btn btn-danger">Un Follow <i class="fa fa-minus-circle" aria-hidden="true"></i></a>
                    @else
                        <a href="{{route('profile.follow',$followedUser_id)}}" style="margin-left: 880px;margin-bottom: 10px;color: white" class="btn btn-primary">Follow <i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                    @endif
                </div>
                            ...
                            <div class="header row ">
                                <div class="col-2">
                                    <div class=" pt-2 pl-2 d-inline-block">
                                        <div class="Profile-Picture " style="background: url({{asset('img/users/profile_picture/' . \App\Models\User::find($followedUser_id)->profile_photo)}}) "></div>
                                    </div>
                                </div>
                                <div class="col-9 p-l-0" style="margin-left: -60px; margin-right: 60px ">
                                    <div class="UserName d-inline-block mt-3">
                                        <p><a href="" class="font-weight-bold">{{\App\Models\User::find($followedUser_id)->name}}</a></p>
                            ...
                            <div class="footer ">
                                <form action="{{route('comment.add',[$post->id,Auth::id()])}}" method="post">
                                    ...
                                    <div class="row action-btn ">
                                        ...
                                        <div class="col border-left">
                                            <p class=" py-2 footer-btn text-center"><a href="{{route('post.share.add',$post->id)}}"><i class="fa fa-share-square-o" aria-hidden="true"></i> <span class="px-1"> Share</span></a></p>
                                        </div>
                                    </div>
                                    <hr class="mt-0 mb-2">
