                    ...
                    <div class="col-3 mobile-hidden">
                        <div class="main-block">
                            ...
                            <div class="row statistic text-center fs-16 p-3">
                                <div class="col "><p>Friends</p> <br> <p>{{Auth::user()->followByYou->count()}}</p></div>
                                <div class="col border-left"><p>Posts</p> <br> <p>{{auth()->user()->post()->count()}}</p></div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="header row ">
                                    <div class="col-2">
                                        <div class=" pt-2 pl-2    d-inline-block">
                                            <div class="Profile-Picture " style="background: url({{asset('img/users/profile_picture/' . \App\Models\User::find($post->user_id)->profile_photo)}}) "></div>
                                        </div>
                                    </div>
                                    <div class="col-8 p-l-0">
                                        <div class="UserName d-inline-block mt-3">
                                                <p><a href="{{route('following',$post->user_id)}}" class="font-weight-bold">{{\App\Models\Post::getUsername($post->user_id)}}</a></p>
                                ...
                                <div class="footer ">
                                    ...
                                    <div class="row action-btn ">
                                        ...
                                        <div class="col border-left">
                                            <p class=" py-2 footer-btn text-center"><button style="font-family: Poppins-Regular;font-size: 14px;line-height: 1.7;color: #666666;"><i class="fa fa-comment-o" aria-hidden="true"></i> <span class="px-1"> Comment</span></button></p>
                                        </div>
                                        ...
                                        <div class="comment col-12 pt-0">
                                            <div class="row">
                                                ...
                                                <div class="comment-box col-10 pl-0">
                                                    <div class="row pr-2 pt-2 pb-2 pl-0">
                                                        <div class="col pl-0">
                                                            <a class="font-weight-bold" href="{{route('following',$comment->user_id)}}">{{\App\Models\Comment::getUsername($comment->user_id)}}</a>
                    ...
                    <div class="col-3 mobile-hidden">
                        <div class="main-block">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class=" pt-2 pl-2 d-inline-block">
                                        <div class="Profile-Picture " style="background: url({{asset('img/users/profile_picture/' . \App\Models\User::find($nonFollowing->id)->profile_photo)}});width: 40px;height: 40px;    border: 1.5px solid #8B54C7; "></div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="UserName d-inline-block mt-3">
                                        <p><a href="{{route("following",$nonFollowing->id)}}" class="font-weight-bold">{{$nonFollowing->name}}</a></p>
